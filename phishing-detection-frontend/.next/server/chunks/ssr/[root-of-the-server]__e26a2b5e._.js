...
function Home() {
    ...
    const handleCheck = async ()=>{
        ...
        try {
            ...
            // Redirect
            router.push(`/result?type=${newItem.type}&input=${encodeURIComponent(newItem.input)}&verdict=${data.verdict}`);
            setUrl("");
            setEmail("");
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e26a2b5e._.js.map